            ...
            <div class="scroll-sidebar">
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        ...
                        <li> <a href="{{url('/course')}}" ><span> <i class="fa fa-book"></i> </span><span class="hide-menu">Courses</span></a></li>
                        <li> <a href="{{url('/photo')}}" ><span> <i class="fa fa-camera"></i> </span><span class="hide-menu">Photo Gallery</span></a></li>
					</ul>
                </nav>
            </div>
        </aside>
